const quizData = [
    ...
    {
     question: "What is the correct CSS syntax to change the background color of a div?",

        a:"A) div {background-color: blue;}",
        b:"B) body {background-color: blue;}",
        c:"C) #div {background-color: blue;}",
        d:"D) background-color: blue;",
     correct: "a"
    },
    {
     question: "Which JavaScript function is used to display data in an alert box?",
